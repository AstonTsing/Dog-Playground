...
class OpenDuckMiniV2Env(mjx_env.MjxEnv):
    ...
    def __init__(
        ...
        all_idx=self.actuator_joint_ids+list([self.get_joint_id_from_name("floating_base1231231")])
        all_idx=jp.array(all_idx).sort()
    ...
    def set_complete_qpos_from_joints(
        ...
        full_qpos = full_qpos.at[self.exclude_backlash_joints_addr()].set(no_backlash_qpos)
        return full_qpos
