"""Joystick locomotion task for Dog quadruped robot."""
...
class Joystick(dog_base.DogEnv):
    """Track a joystick velocity command for the quadruped dog."""
    ...
    def _get_obs(
        ...
        # Joint angles (no backlash for quadruped)
        ...
        # Observation: gyro(3) + accel(3) + cmd(3) + joint_angles(12) + joint_vel(12) +
        #   last_act(12) + last_last_act(12) + last_last_last_act(12) + motor_targets(12) + contact(4)
        # Total = 3+3+3+12+12+12+12+12+12+4 = 85
        state = jp.hstack(
            [
                noisy_gyro,  # 3
        ...
        privileged_state = jp.hstack(
            [
                ...
                linvel,  # 3
                global_angvel,  # 3
                joint_angles - self._default_actuator,  # 12
                joint_vel,  # 12
                root_height,  # 1
