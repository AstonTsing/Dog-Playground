"""Standing task for Dog quadruped robot."""
...
class Standing(dog_base.DogEnv):
    """Standing balance policy for the quadruped dog."""
    ...
    def sample_command(self, rng: jax.Array) -> jax.Array:
        # Standing task: command is always zero (no movement)
        return jp.zeros(3)
